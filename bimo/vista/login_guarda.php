...
<body class="subpage">
	...
	<header id="header">
		<div class="inner">
			<a href="../vista/login_guarda.php" class="logo">
		...
		<div class="inner">
			<div class="flex flex-2">
				<article>
					...
					<header>
						<h5>Iniciar sesión como</h5><h3>Guarda de seguridad</h3>
					</header>
								...
								switch($_GET['e'])
								{
									...
									?>
										<script type='text/javascript'>
										    ...
										    window.location='http://bimoprueba.epizy.com/bimo/vista/login_guarda.php';
										</script>
									<?php
								}
							}
