...
<body class="subpage">
	...
	<header id="header">
		<div class="inner">
			<a href="../vista/login_administrador.php" class="logo">
		...
		<div class="inner">
			<div class="flex flex-2">
				<article>
					...
					<header>
						<h5>Iniciar sesión como</h5><h3>Administrador</h3>
					</header>
								...
								switch($_GET['e'])
								{
									...
									?>
										<script type='text/javascript'>
										    ...
										    window.location='http://bimoprueba.epizy.com/bimo/vista/login_administrador.php';
										</script>
									<?php
								}
							}
				...
				<article>
					...
					<p><h5>Iniciar sesión como</h5><a href="http://bimoprueba.epizy.com/bimo/vista/login_supervisor.php" class="button"><span class="icon-user-tie"></span>&nbsp SUPERVISOR</a></p>
